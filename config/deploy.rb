...
set :application, 'vcard'
set :repo_url, 'git@github.com:Gring0/vcard.git'

application = 'vcard'
set :rvm_type, :system
set :rvm_ruby_version, '2.1.1'
set :deploy_to, '/var/www/apps/vcard'
  ...
  task :foreman_init do
    on roles(:all) do
      ...
      within current_path do
        ...
        execute :bundle, "exec foreman export upstart #{foreman_temp} -a #{application} -u root -l /var/www/apps/#{application}/log -d #{current_path}"
      end
